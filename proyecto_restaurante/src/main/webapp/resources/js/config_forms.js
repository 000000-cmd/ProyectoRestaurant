// config_forms.js
import { setupFormListeners } from './config_formsComplementos/utils.js';
import { handlePlatosForm } from './config_formsComplementos/platos.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (formulario) {
        setupFormListeners(formulario); // Pass the form to setup form listeners
    }
    ...
    switch (mode) {
        ...
        case 'addRol':
        case 'editRol':
            handleRolesForm(mode, IdForm, formulario);
            break;
        case 'addCategoria':
        case 'editCategoria':
            handleCategoriasForm(mode, IdForm, formulario);
            break;
        case 'addUsuario':
        case 'editUsuario':
            handleUsuariosForm(mode, IdForm, formulario);
            break;
        default:
...
function manejarFormularioSubmit(e) {
    ...
    switch (formId) {
        case "addDish":
        case "editDish":
            handlePlatosForm(formId, null, formulario);
            break;
        case "addRol":
        case "editRol":
            handleRolesForm(formId, null, formulario);
            break;
        case "addCategoria":
        case "editCategoria":
            handleCategoriasForm(formId, null, formulario);
            break;
        case "addUsuario":
        case "editUsuario":
            handleUsuariosForm(formId, null, formulario);
            break;
        default:
