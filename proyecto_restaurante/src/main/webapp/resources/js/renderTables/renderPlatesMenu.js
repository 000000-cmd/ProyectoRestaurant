...
export function crearTabContentAdmin(id, container, platos) {
    ...
    newDishCard.setAttribute("onclick", "window.location.href='form_plates.html?mode=addDish'");
    ...
    platos.forEach(plato => {
        ...
        cardContainer.setAttribute("data-plate", `plate-${plato.id_plato}`); // Asigna un valor al atributo
        ...
        editButton.setAttribute("onclick", `window.location.href='form_plates.html?mode=editDish&id=${plato.id_plato}'`);
...
export function crearTab(nombre, id, container) {
...
export function manejarNavegacionTabs() {
